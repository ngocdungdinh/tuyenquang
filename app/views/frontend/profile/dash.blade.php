					...
					<div class="box-info">
						<div class="well p2" style="border: none">
							<ul class="nav nav-tabs bold">
							  <li class="active"><a href="{{ URL::to('/u/'.$profile->username) }}"><span class="glyphicon glyphicon-question-sign"></span> Hỏi đáp</a></li>
							  <li><a href="{{ URL::to('/u/'.$profile->username.'?p=follows') }}"><span class="glyphicon glyphicon-heart"></span> Bác sĩ yêu thích</a></li>
							</ul>
							@if($posts->count())
							@elseif(!is_null($u) && $u->id == $profile->id)
								<div class="welcome">
									<h3>Hello</h3>
								</div>
							@else
