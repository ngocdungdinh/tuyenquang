      ...
      <div class="modal-body">
        <form method="post" action="{{ route('updatewr/widgets') }}" autocomplete="off" class="form-horizontal" role="form" id="widgetForm">
          ...
          <div class="form-group">
            <label class="col-lg-3 control-label" for="title">Tiêu đề</label>
            <div class="col-lg-7">
              <input class="form-control" type="text" name="title" id="title" value="{{ $widget->title }}" />
            </div>
          </div>
          <div class="form-group">
            <label class="col-lg-3 control-label">Hiện?</label>
            <div class="col-lg-4">
          ...
          <div class="form-group">
            <label class="col-lg-3 control-label" for="title">Trạng thái</label>
            <div class="col-lg-4">
