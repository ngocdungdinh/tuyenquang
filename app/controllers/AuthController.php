...
class AuthController extends BaseController {
	...
	public function postSignup()
	{
		// Declare the rules for the form validation
		$rules = array(
			'username' 		   => 'required|alpha_dash|not_in:'.Config::get('auth.blacklist').'|unique:users,username|min:3',
		...
		try
		{
			...
			// send mail
			Mailer::sendmail('register-activate', $data, $user, $user, false);
	...
	public function postForgotPassword()
	{
		...
		try
		{
			...
			Mailer::sendmail('forgot-password', $data, $user, $user, false);
		}
		catch (Cartalyst\Sentry\Users\UserNotFoundException $e)
		{
